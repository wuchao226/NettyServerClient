package com.wuc.server.adapter
...
class LogAdapter : RecyclerView.Adapter<LogAdapter.ItemHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemHolder {
        return ItemHolder(LayoutInflater.from(parent.context).inflate(com.wuc.server.R.layout.log_item, parent, false))
    }
    ...
    inner class ItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var mTime: TextView = itemView.findViewById(com.wuc.server.R.id.time) as TextView
        var mLog: TextView = itemView.findViewById(com.wuc.server.R.id.logtext) as TextView
